...
if __name__ == '__main__':
    ...
    # testing_data = pd.read_csv(os.getcwd() +'/../data/28_test_value_data_D14.csv',index_col =0)
    ...
    print("-" * 50)
    print("default_Random_ForestR result - features(56)")
    default_Random_ForestR = RandomForestRegressor(random_state = 42)
    default_Random_ForestR.fit(dataset_train, target_train)
    resultAllPredict(default_Random_ForestR, test_dataset, test_target, "RandomForest_D14")
    print("-"*50)
    ...
    print("-" * 50)
    print("default_Random_ForestR_Most_Importance_99 result - features(21)")
    ...
    resultAllPredict(default_Random_ForestR_Most_Importance_99, important_test_dataset, test_target, "RandomForest_D14")
    ...
    print("-" * 50)
    print("grid_search_99 result - features(21)")
    resultAllPredict(grid_Search_default_RF_99, important_test_dataset, test_target, "RandomForest_D14")
