...
if __name__ == '__main__':
    ...
    modeling_data = pd.read_csv(os.getcwd() + '/../checkcheck/valueD0.csv', index_col=0)
    ...
    def visualizationImportance(name,dataset_columns,feature_list):
        ...
        plt.xticks(xvalues, dataset_columns, rotation=30, fontsize=10)
        plt.title("RandomForest_D0 "+name, fontsize=15, verticalalignment='bottom')
        plt.show()
    # 기본조건으로 시작
    ...
    #
    # print("-" * 50)
    # print("무작위 서칭 튜닝 결과 (random_Search_RF) - features 15개")
    # random_searching_best_estimator_ = {'n_estimators': 50, 'min_samples_split': 11, 'min_samples_leaf': 1, 'max_features': 'sqrt', 'max_depth': 20, 'bootstrap': False}
    ...
    # # print("-" * 50)
    # #
    # print("그리드 서칭 튜닝 결과 (grid_Search_RF) - features 15개")
    # default_Random_Forest_grid_searching_best_estimators = {'bootstrap': False, 'max_depth': 60,
    #                                                         'max_features': 'sqrt', 'min_samples_leaf': 1,
    #                                                         'min_samples_split': 2, 'n_estimators': 400} # 97개 짜리
    # default_Random_Forest_grid_searching_best_estimators = {'bootstrap': False, 'max_depth': 20, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 50}
    ...
    # 변수: repGenreNm_score     중요도: 0.01247 --- 0.94699
    ...
    # 변수: prdtYear_score       중요도: 0.0049 --- 0.99331
    ...
    #
    #
    # print("-"*50,"\n Default - 랜덤포레스트에서 찾은 중요 변수 6개") # 95%
    ...
    # default_Random_ForestR_Most_Importance_95_result = {'model': 'important6',
    ...
    # # # ---------------------------------------------------------------------------------------------------------------2.1
    # print("그리드 서칭 튜닝 결과 (grid_Search_default_RF_95) - features 6개, 중요도 95% 차지")
    ...
    # # #---------------------------------------------------------------------------------------------------------------2.2
    #
    # print("-" * 50, "\n Default - 랜덤포레스트에서 찾은 중요 변수 13개")  # 99%
    # default_Random_ForestR_Importance_features_list = []  # 주요변수 담은 리스트공간
    # for i in range(0, 13):
    #     default_Random_ForestR_Importance_features_list.append(feature_importances[i][0])
    # important_indices = []  # 실제 인덱스 담을 리스트공간
    ...
    # #     test_target, test_target)
    # # # visualizationTree("default_MI95_tree", default_Random_ForestR_Most_Importance_95, default_Random_ForestR_Importance_features_list)
    # # default_Random_ForestR_Most_Importance_99_result = {'model': 'important6',
    # #                                                     'accuracy':
    # #                                                         default_Random_ForestR_Most_Importance_99_AccuracyWithError[
    # #                                                             0],
    # #                                                     'train_error':
    # #                                                         default_Random_ForestR_Most_Importance_99_AccuracyWithError[
    # #                                                             1],
    ...
    # #                                                             2],
    # #                                                     'n_trees':
    # #                                                         default_Random_ForestR_Most_Importance_99.get_params()[
    # #                                                             'n_estimators'],
    # #                                                     'n_features': len(
    # #                                                         default_Random_ForestR_Importance_features_list)}
    # # print('향상도 of {:0.2f}%.'.format(100 *
    ...
    # #                                 / default_Random_ForestR_AccuracyWithError[0]))
    # #
    # # default_Random_ForestR_Most_Importance_99_grid_searching_best_estimators = {'bootstrap': False, 'max_depth': 60, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 200}
    # # print("그리드 서칭 튜닝 결과 (grid_Search_default_RF_99) - features 13개, 중요도 99% 차지")
    ...
    # # # comparison.to_csv("99_output_RandomForest_D0_Comparison.csv", encoding="utf-8")
    # # #
    # # # ## Plotting
    # # # import matplotlib.pyplot as plt
    ...
    # # # choice grid_95
    # #
    # # print("grid_search_95 resultAll")
    # # resultAllPredict(grid_Search_default_RF_95,all_important_dataset,"RandomForest_D0")
    # #
