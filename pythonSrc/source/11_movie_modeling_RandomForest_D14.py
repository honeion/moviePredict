...
if __name__ == '__main__':
    ...
    modeling_data = pd.read_csv(os.getcwd() + '/../data/10_value_data_D14.csv', index_col=0)
    ...
    def visualizationImportance(name,dataset_columns,feature_list):
        ...
        plt.title("RandomForest_D14 "+name, fontsize=15, verticalalignment='bottom')
        plt.show()
    # 기본조건으로 시작
    '''
     default 값
    ...
    # print("-" * 50)
    # print("무작위 서칭 튜닝 결과 (random_Search_RF) - features 56개")
    # random_searching_best_estimator_ = {'n_estimators': 3000, 'min_samples_split': 7, 'min_samples_leaf': 1, 'max_features': 'auto', 'max_depth': 90, 'bootstrap': True}
    ...
    # # print("-" * 50)
    # #
    # print("그리드 서칭 튜닝 결과 (grid_Search_RF) - features 56개")
    # default_Random_Forest_grid_searching_best_estimators = {'bootstrap': True, 'max_depth': 60, 'max_features': 'auto', 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 2000}
    ...
    #                                  / default_Random_ForestR_AccuracyWithError[0]) )
    # # print("-" * 50)
    # default_Random_ForestR_Most_Importance_95_grid_searching_best_estimators = {'bootstrap': True, 'max_depth': 60, 'max_features': 'auto', 'min_samples_leaf': 1, 'min_samples_split': 7, 'n_estimators': 2000}
    # # # ---------------------------------------------------------------------------------------------------------------2.1
    ...
    print("-" * 50, "\n Default - 랜덤포레스트에서 찾은 중요 변수 21개")  # 99%
    default_Random_ForestR_Importance_features_list = []  # 주요변수 담은 리스트공간
    for i in range(0, 21):
        default_Random_ForestR_Importance_features_list.append(feature_importances[i][0])
    important_indices = []  # 실제 인덱스 담을 리스트공간
    ...
    #     test_target, test_target)
    # # visualizationTree("default_MI95_tree", default_Random_ForestR_Most_Importance_95, default_Random_ForestR_Importance_features_list)
    # default_Random_ForestR_Most_Importance_99_result = {'model': 'important21', 'accuracy': default_Random_ForestR_Most_Importance_99_AccuracyWithError[0],
    ...
    #                                 / default_Random_ForestR_AccuracyWithError[0]))
    #
    # default_Random_ForestR_Most_Importance_99_grid_searching_best_estimators = {'bootstrap': True, 'max_depth': 60, 'max_features': 'auto', 'min_samples_leaf': 1, 'min_samples_split': 2, 'n_estimators': 300}
    # print("그리드 서칭 튜닝 결과 (grid_Search_default_RF_99) - features 21개, 중요도 99% 차지")
    ...
    # # comparison.to_csv("99_output_RandomForest_D14_Comparison.csv", encoding="utf-8")
    # #
    # # ## Plotting
    # # import matplotlib.pyplot as plt
    ...
    # resultAllPredict(grid_Search_default_RF_99,all_important_dataset,"RandomForest_D14")
