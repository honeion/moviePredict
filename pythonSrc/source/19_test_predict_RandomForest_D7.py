...
if __name__ == '__main__':
    ...
    # modeling_data = pd.read_csv(os.getcwd() +'/../data/12_value_data_D7_1800.csv',index_col =0)
    modeling_data = pd.read_csv(os.getcwd() + '/../data/23_non_scaled_value_data_D7.csv', index_col=0)
    # testing_data = pd.read_csv(os.getcwd() +'/../data/29_test_value_data_D7.csv',index_col =0)
    testing_data = pd.read_csv(os.getcwd() + '/../data/33_test_non_scaled_value_data_D7.csv', index_col=0)
  ...
  # 이게 1 세트 -> 모델 선언, 피팅, 예측, 정확도 검증, 전체 결과 확인, 트리 시각화
    print("-" * 50)
    print("default_Random_ForestR result - features(23)")
    default_Random_ForestR = RandomForestRegressor(random_state = 42)
    default_Random_ForestR.fit(dataset_train, target_train)
    resultAllPredict(default_Random_ForestR, test_dataset, test_target, "RandomForest_D7")
    print("-"*50)
    ...
    print("-" * 50)
    print("default_Random_ForestR_Most_Importance_99 result - features(23)")
    ...
    resultAllPredict(default_Random_ForestR_Most_Importance_99, important_test_dataset, test_target, "RandomForest_D7")
    ...
    # choice important23
    print("grid_search_99 result - features(23)")
    resultAllPredict(grid_Search_default_RF_99, important_test_dataset, test_target,"RandomForest_D7")
