...
if __name__ == '__main__':
    ...
    def visualizationImportance(name,dataset_columns,feature_list):
        ...
        plt.title("RandomForest_D7 "+name, fontsize=15, verticalalignment='bottom')
        plt.show()
    # def visualizationImportance(name,dataset_columns,feature_list):
    #     xvalues = range(0, len(feature_list))
    #     # plt.bar(y_pred,y_test,color='b')
    ...
    #     plt.grid(color='black', linestyle='--', )
    #     # plt.subplot(131)
    #     plt.bar(xvalues, feature_list, color='purple')
    ...
    print("-" * 50)
    print("무작위 서칭 튜닝 결과 (random_Search_RF) - features 35개")
    random_searching_best_estimator_ = {'n_estimators': 200, 'min_samples_split': 5, 'min_samples_leaf': 1, 'max_features': 'sqrt', 'max_depth': 20, 'bootstrap': False}
    ...
    # print("-" * 50)
    #
    print("그리드 서칭 튜닝 결과 (grid_Search_RF) - features 35개")
    default_Random_Forest_grid_searching_best_estimators = {'bootstrap': False, 'max_depth': 20, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 200}
    ...
    print("-"*50,"\n Default - 랜덤포레스트에서 찾은 중요 변수 10개") # 95%
    ...
    default_Random_ForestR_Most_Importance_95_result = {'model': 'important10',
    ...
    print('향상도 of {:0.2f}%.'.format(100 *
                                    (default_Random_ForestR_Most_Importance_95_AccuracyWithError[0] - default_Random_ForestR_AccuracyWithError[0])
                                     / default_Random_ForestR_AccuracyWithError[0]) )
    # print("-" * 50)
    default_Random_ForestR_Most_Importance_95_grid_searching_best_estimators = {'bootstrap': True, 'max_depth': 10, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 200}
    # # ---------------------------------------------------------------------------------------------------------------2.1
    print("그리드 서칭 튜닝 결과 (grid_Search_default_RF_95) - features 10개, 중요도 95% 차지")
    ...
    print("-" * 50, "\n Default - 랜덤포레스트에서 찾은 중요 변수 23개")  # 99%
    default_Random_ForestR_Importance_features_list = []  # 주요변수 담은 리스트공간
    for i in range(0, 23):
        default_Random_ForestR_Importance_features_list.append(feature_importances[i][0])
    important_indices = []  # 실제 인덱스 담을 리스트공간
    ...
    #     test_target, test_target)
    # # visualizationTree("default_MI95_tree", default_Random_ForestR_Most_Importance_95, default_Random_ForestR_Importance_features_list)
    # default_Random_ForestR_Most_Importance_99_result = {'model': 'important23',
    #                                                     'accuracy':
    ...
    #                                 / default_Random_ForestR_AccuracyWithError[0]))
    #
    # default_Random_ForestR_Most_Importance_99_grid_searching_best_estimators = {'bootstrap': False, 'max_depth': None, 'max_features': 'sqrt', 'min_samples_leaf': 1, 'min_samples_split': 5, 'n_estimators': 200}
    # print("그리드 서칭 튜닝 결과 (grid_Search_default_RF_99) - features 23개, 중요도 99% 차지")
    ...
    # comparison.to_csv("99_output_RandomForest_D7_Comparison.csv", encoding="utf-8")
    #
    # ## Plotting
    # import matplotlib.pyplot as plt
    ...
    # resultAllPredict(default_Random_ForestR_Most_Importance_99, all_important_dataset,"RandomForest_D7")
